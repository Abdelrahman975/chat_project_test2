...
class NewsData {
  ...
  static Future<List<NewsData>> fetchBreakingNews() async {
    try {
      var response = await Dio().get(
          'https://newsapi.org/v2/top-headlines?country=us&apiKey=899c49dd9292495e8b7b2b266f63f082&category=general');
      List<dynamic> articles = response.data['articles'];

      List<NewsData> newsList = articles.map((article) {
        return NewsData(
          article['title'],
          article['author'],
          article['description'],
  ...
  static Future<List<NewsData>> fetchRecentNews() async {
    try {
      var response = await Dio().get(
          'https://newsapi.org/v2/top-headlines?country=us&apiKey=899c49dd9292495e8b7b2b266f63f082&category=health');
      List<dynamic> articles = response.data['articles'];

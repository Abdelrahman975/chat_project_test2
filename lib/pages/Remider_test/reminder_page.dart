import 'package:chat_project_test2/pages/Remider_test/constants.dart';
import 'package:chat_project_test2/pages/Remider_test/global_bloc.dart';
...
class ReminderPageTest extends StatefulWidget {
  const ReminderPageTest({super.key});
  static String id = 'ReminderPageTest';

  @override
  State<ReminderPageTest> createState() => _ReminderPageState();
}

class _ReminderPageState extends State<ReminderPageTest> {
